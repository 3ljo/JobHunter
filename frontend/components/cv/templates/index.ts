...
import {
  NursingCare, UniversityFaculty, DentalPractice, SolicitorUK, LawEnforcement, MilitaryVeteran,
  AviationPilot, CulinaryChef, FitnessTrainer, NgoFieldWorker, TranslatorLinguist, AccountantCPA,
  ArcticMinimal, TerracottaEarth, LavenderCalm, EmeraldLuxe, SapphireRoyal, PlumModern,
  MustardBold, SeafoamCoastal, RoseElegant, CoalIndustrial, ForestDeep, CrimsonPower,
  MochaWarm, CobaltTech, AshQuiet, RetroEighties, ModernistBold, UltraMinimal,
  CoolGradient, ChromeMetal, PastoralCountry, ZenJapandi, IndustrialSteel, PaperbackNovel,
  MidnightBlue, CoralCalm, AshFog, GoldRoyal, ScarletPro, TealClean,
  NavyCoral, BronzeWarm, VioletElegant, OrangeBold, CharcoalSerif, MaroonClassic,
  JadeNatural, SilverElite,
} from './BulkTemplates';
...
export const TEMPLATE_COMPONENTS: Record<TemplateId, React.FC<TemplateProps>> = {
  ...
  solicitor: SolicitorUK,
  police: LawEnforcement,
  military: MilitaryVeteran,
  aviation: AviationPilot,
  culinary: CulinaryChef,
  fitness: FitnessTrainer,
  ngofield: NgoFieldWorker,
  translator: TranslatorLinguist,
  accountant: AccountantCPA,
  arctic: ArcticMinimal,
  terracotta: TerracottaEarth,
  lavender: LavenderCalm,
  emerald: EmeraldLuxe,
  sapphire: SapphireRoyal,
  plum: PlumModern,
  mustard: MustardBold,
  seafoam: SeafoamCoastal,
  rose: RoseElegant,
  coal: CoalIndustrial,
  forest: ForestDeep,
  crimson: CrimsonPower,
  mocha: MochaWarm,
  cobalt: CobaltTech,
  ash: AshQuiet,
  retro: RetroEighties,
  modernist: ModernistBold,
  ultramin: UltraMinimal,
  coolgrad: CoolGradient,
  chrome: ChromeMetal,
  pastoral: PastoralCountry,
  zen: ZenJapandi,
  industrial: IndustrialSteel,
  paperback: PaperbackNovel,
  ...
  navycoral: NavyCoral,
  bronze: BronzeWarm,
  violet: VioletElegant,
  orangebold: OrangeBold,
  charcoalserif: CharcoalSerif,
  maroon: MaroonClassic,
  jade: JadeNatural,
  silverelite: SilverElite,
};
