  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Form content is ALWAYS mounted so its internal state survives generation ── */}
        ...
        {/* ── Fixed loading overlay — fills the viewport without unmounting the form ── */}
        {submitting && (
          <div
          ...
          >
            ...
            <div className="absolute inset-0" style={{ background: 'rgba(8,11,32,0.72)', zIndex: 1 }} />
            <div className="relative text-center" style={{ zIndex: 2 }}>
              <span className="aivent-subtitle s2">AI-Powered</span>
              <h1
                className="text-white leading-[1.1] mt-2 mb-4"
              ...
              <p
                className="mx-auto"
                style={{ color: 'rgba(255,255,255,0.55)', fontSize: '15px', lineHeight: 1.7, maxWidth: '480px' }}
              >
